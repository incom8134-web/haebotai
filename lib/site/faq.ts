...
export const FAQ: { category: FaqCategory; q: Bilingual; a: Bilingual }[] = [
  ...
  { category: "credits", q: { ko: "크레딧은 언제 초기화되나요?", en: "When do credits reset?" }, a: { ko: "유료 플랜은 결제일 기준 매월 초기화됩니다. 남은 크레딧은 이월되지 않습니다.", en: "Paid plans reset monthly on your billing date. Unused credits don't roll over." } },
