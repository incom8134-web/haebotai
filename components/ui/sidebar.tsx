...
function SidebarMenuSkeleton({
  ...
  const width = React.useMemo(() => {
    // eslint-disable-next-line react-hooks/purity -- one-time random skeleton width per mount, memoized so it never changes across re-renders
    ...
    props: mergeProps<"a">(
      {
        ...
        "data-active": isActive,
        className: cn(
          "flex h-7 min-w-0 -translate-x-px items-center gap-2 overflow-hidden rounded-md px-2 text-sidebar-foreground ring-sidebar-ring outline-hidden hover:bg-sidebar-accent hover:text-sidebar-accent-foreground active:bg-sidebar-accent active:text-sidebar-accent-foreground focus-visible:ring-2 disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 [&>svg]:size-4 [&>svg]:shrink-0 [&>svg]:text-sidebar-accent-foreground [&>span:last-child]:truncate",
